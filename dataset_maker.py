...
def parse_args():
    ...
    parser.add_argument('--csv_out_path', type=str, default='/home/vault/iwi5/iwi5207h/new/CheXzero/dataset/training_fold_3.csv', help="Directory to save paths to all chest x-ray images in dataset.")
    parser.add_argument('--cxr_out_path', type=str, default='/home/vault/iwi5/iwi5207h/new/CheXzero/dataset/training_fold_3.h5', help="Directory to save processed chest x-ray image data.")
    ...
    parser.add_argument('--csv_input_path', default='/home/hpc/iwi5/iwi5207h/Thesis/dataset_csv/training/train_fold_3.csv', help="CSV file containing the image paths to process.")
